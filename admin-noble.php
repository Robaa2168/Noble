...
session_start();
// connect to database
$con = mysqli_connect("localhost", "robaa", "password", "Nurucoin");
if (!$con) {
...
if($decryt_password == 0){
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="admin-noble.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
    </p>
  </div>
</div>
...
?>
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = 'admin_admin.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
<?php
