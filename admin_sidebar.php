		...
		<div class="sidebar-wrapper" style="z-index:9999 !important;" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="admin_admin.php"><i class="bx bx-right-arrow-alt"></i>Main</a>
                        </li>
                        <li> <a href="admin_users.php"><i class="bx bx-right-arrow-alt"></i>Users</a>
						</li>
						<li> <a href="admin_investments.php"><i class="bx bx-right-arrow-alt"></i>Investments</a>
						</li>
						<li> <a href="new_transaction.php"><i class="bx bx-right-arrow-alt"></i>Admin_transaction</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li> <a href="admin_tran.php"><i class="bx bx-right-arrow-alt"></i>Sold</a>
						</li>
						<li> <a href="admin_bought.php"><i class="bx bx-right-arrow-alt"></i>Bought</a>
                        </li>
				...
				<li>
					...
					<ul>
                    <li> <a href="admin_logout.php"><i class="bx bx-right-arrow-alt"></i>Logout</a>
						</li>
				...
				<nav class="navbar navbar-expand bg-gradient-orange">
					...
					<div class="user-box dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end" style="z-index:9999 !important;">
							...
							<li><a class="dropdown-item" href="admin_user-profile.php"><i class="bx bx-cog"></i><span>Settings</span></a>
							</li>
							<li><a class="dropdown-item" href="admin_dashboard.php"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
							</li>
							<li><a class="dropdown-item" href="admin_dashboard.php"><i class='bx bx-dollar-circle'></i><span>Earnings</span></a>
							</li>
